...
export default function PremiumThemePreviewPage() {
    ...
    return (
      <main className="min-h-screen bg-[#f8f4ef] px-4 py-10">
        <div className="mx-auto max-w-md rounded-3xl border border-[#e7ddd1] bg-white p-7 text-center">
          <h1 className="font-serif text-3xl text-[#5f4c2e] font-bold mb-2">Memuat preview</h1>
          <p className="text-sm text-[#8d7a5d]">Mengambil preset dari API katalog.</p>
        </div>
      </main>
    );
  }
      ...
      <article className="mx-auto max-w-[430px] overflow-hidden rounded-[2rem] border border-[#e6d9c9] bg-[#fdf9f3] shadow-soft">
        <section className="relative min-h-[560px] overflow-hidden">
          ...
          <div className="relative z-10 min-h-[560px] px-6 py-10 flex flex-col items-center text-center text-white">
            <p className="text-[11px] font-semibold uppercase tracking-[0.24em]">Premium Wedding Invitation</p>
        ...
        {opened ? (
          <>
            <section className="px-6 py-10 text-center bg-[#f8f0e4]">
              <p className="text-[11px] font-bold uppercase tracking-[0.22em] text-[#8f7649] mb-4">QS. Ar-Rum : 21</p>
            ...
            <section className="px-6 py-10 bg-[#fffaf3]">
              <h2 className="text-center font-serif text-3xl text-[#6f5932] mb-7">Mempelai</h2>
              <div className="grid grid-cols-2 gap-3">
                <article className="rounded-3xl border border-[#e7d8c5] bg-white p-3 text-center">
                  ...
                  <p className="font-serif text-3xl text-[#6f5932] mt-3">{groomName}</p>
                ...
                <article className="rounded-3xl border border-[#e7d8c5] bg-white p-3 text-center">
                  ...
                  <p className="font-serif text-3xl text-[#6f5932] mt-3">{brideName}</p>
                  <p className="text-[11px] text-[#907d60]">Putri Kedua</p>
                </article>
              </div>
            </section>

            <section className="px-6 py-10 bg-[#f7efe3]">
              <h2 className="text-center font-serif text-3xl text-[#6f5932] mb-6">Rangkaian Acara</h2>
            ...
            <section className="px-6 py-10 bg-[#fffbf5]">
              <h2 className="text-center font-serif text-3xl text-[#6f5932] mb-6">Galeri</h2>
            ...
            <section className="px-6 py-10 bg-[#f7efe3]">
              <h2 className="text-center font-serif text-3xl text-[#6f5932] mb-6">RSVP</h2>
              <form className="space-y-3">
                ...
                <textarea
                  ...
                  className="w-full rounded-xl border border-[#dfd0bc] bg-white px-4 py-3 text-sm focus:outline-none"
                ></textarea>
                <button type="button" className="w-full rounded-full bg-[#7b6338] text-white py-3 text-sm font-bold">
                  Kirim RSVP
                </button>
              </form>
            </section>
