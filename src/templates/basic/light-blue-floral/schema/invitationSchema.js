 ...
 * @property {string} name - Nama tamu undangan
 * @property {string} greetingLabel - "Kepada Bapak/Ibu/Saudara/i"
 * @property {string} [code] - Kode tracking RSVP opsional
 */
 ...
 * @property {string} parentInfo - "Putra/i dari Bapak X & Ibu Y"
 */

/**
 * @typedef {Object} EventDetail
 * @property {string} date - Contoh: "Sabtu, 15 Maret 2026"
 * @property {string} time - Contoh: "09.00 WIB"
 * @property {string} address
 * @property {string} [mapsUrl]
 */

/**
 * @typedef {Object} LoveStoryItem
 ...
 * @property {{ groom: Person, bride: Person, heroPhoto?: string }} couple
 * @property {{
 *   dateISO: string,
 *   akad: EventDetail,
 *   resepsi: EventDetail,
 *   livestream?: { date: string, time: string, platformLabel: string, url: string }
 * }} event
 * @property {{
 ...
 *   closingText: string
 * }} copy
 * @property {LoveStoryItem[]} lovestory
 * @property {string[]} gallery
 * @property {{
 *   countdownEnabled: boolean,
 *   saveTheDateEnabled: boolean,
 *   digitalEnvelopeEnabled: boolean,
 *   digitalEnvelopeInfo: { bankList: Array<{bank: string, account: string, name: string}> },
 *   rsvpEnabled: boolean,
